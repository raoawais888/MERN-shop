       ...
       <aside className="left-sidebar" data-sidebarbg="skin6">
            ...
            <div className="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav className="sidebar-nav">
                    <ul id="sidebarnav">
                        <li className="sidebar-item"> <NavLink className="sidebar-link sidebar-link" to="/dashboard"
                        ...
                        <li className="sidebar-item"> <NavLink className="sidebar-link sidebar-link" to="/users"
                                aria-expanded="false"><i data-feather="home" className="feather-icon"></i><span
                                    className="hide-menu">Users</span></NavLink></li>
                        <li className="list-divider"></li>


                        <li className="sidebar-item"> <NavLink className="sidebar-link" to="/brand"
                                aria-expanded="false"><i data-feather="tag" className="feather-icon"></i><span
                                    className="hide-menu">Brands
                                </span></NavLink>
                        </li>
                        <li className="sidebar-item"> <NavLink className="sidebar-link" to="/category"
                                aria-expanded="false"><i data-feather="tag" className="feather-icon"></i><span
                                    className="hide-menu">Categories
                                </span></NavLink>
                        </li>
                        <li className="sidebar-item"> <NavLink className="sidebar-link" to="/size"
                                aria-expanded="false"><i data-feather="tag" className="feather-icon"></i><span
                                    className="hide-menu">Sizes
                                </span></NavLink>
                        </li>
                        <li className="sidebar-item"> <NavLink className="sidebar-link" to="/add-product"
                                aria-expanded="false"><i data-feather="tag" className="feather-icon"></i><span
                                    className="hide-menu">Add Product
                                </span></NavLink>
                        </li>
